...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            skills: ["Docker","Kubernetes","AWS","Front-end development", "React.js", "Next.js", "Node.js", "Express.js", "SQL", "Firebase"],
            projects: ["TimeIt(A Live Streaming App) ", "Voice Your Opinion", "Levenstein Spell Checking Algorithm "],
            interests: ["Software Engineering", "Deep Learning", "Computer Vision","Data Science","Machine Learning","Cloud Computing"],
            languages: ["Javascript", "C++", "Typescript", "Python","Rust","GO"],
        };
        this.state = {
            terminal: [],
        }
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">aklamaash@lenovo</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/aklamaash")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-aklamaash, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "trash":
                ...
                break;
            case "about-aklamaash":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-aklamaash");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-aklamaash, todoist, trash, settings, sendmsg ]";
                }
                break;
